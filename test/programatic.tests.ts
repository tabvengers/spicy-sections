...
const DEFAULT_PAGE_URL = 'http://localhost:3000/demonstration/default/'
const DISCLOSURE_PAGE_URL = 'http://localhost:3000/demonstration/disclosure/'

// Fixture
// -----------------------------------------------------------------------------

fixture('Panelset Programatic Affordances (with no "affordance" attribute)').page(DEFAULT_PAGE_URL)
...
fixture('Panelset Programatic Affordances (with affordance="disclosure")').page(DISCLOSURE_PAGE_URL)
